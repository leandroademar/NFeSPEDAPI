...
/// </summary>
/// <remarks></remarks>
public class RegistroC170 : Registro
{
    ...
    public override void LeParametros(string[] data)
    {
        ...
        // ## ICMS:
        Origem = (EficazFramework.SPED.Schemas.NFe.OrigemMercadoria)data[10][..1].ToEnum<EficazFramework.SPED.Schemas.NFe.OrigemMercadoria>(EficazFramework.SPED.Schemas.NFe.OrigemMercadoria.Nacional);
        CST_ICMS = (EficazFramework.SPED.Schemas.NFe.CST_ICMS)data[10].Substring(1, 2).ToEnum<EficazFramework.SPED.Schemas.NFe.CST_ICMS>(EficazFramework.SPED.Schemas.NFe.CST_ICMS.CST_00);
        CFOP = data[11];
        ...
        // ## PIS:
        CST_PIS = (EficazFramework.SPED.Schemas.NFe.CST_PIS)data[25].ToEnum<EficazFramework.SPED.Schemas.NFe.CST_PIS>(EficazFramework.SPED.Schemas.NFe.CST_PIS.NotValid);
        ...
        // ## COFINS:
        CST_COFINS = (EficazFramework.SPED.Schemas.NFe.CST_COFINS)data[31].ToEnum<EficazFramework.SPED.Schemas.NFe.CST_COFINS>(EficazFramework.SPED.Schemas.NFe.CST_COFINS.NotValid);
    ...
    public EficazFramework.SPED.Schemas.NFe.OrigemMercadoria Origem { get; set; } = EficazFramework.SPED.Schemas.NFe.OrigemMercadoria.Nacional;
    public EficazFramework.SPED.Schemas.NFe.CST_ICMS CST_ICMS { get; set; } = EficazFramework.SPED.Schemas.NFe.CST_ICMS.CST_00;
    ...
    public EficazFramework.SPED.Schemas.NFe.CST_PIS CST_PIS { get; set; } = EficazFramework.SPED.Schemas.NFe.CST_PIS.AliquotaNormal;
    ...
    public EficazFramework.SPED.Schemas.NFe.CST_COFINS CST_COFINS { get; set; } = EficazFramework.SPED.Schemas.NFe.CST_COFINS.AliquotaNormal;
