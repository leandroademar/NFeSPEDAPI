...
public class RegistroC185 : Registro
{
    ...
    public override void LeParametros(string[] data)
    {
        ...
        Origem = (EficazFramework.SPED.Schemas.NFe.OrigemMercadoria)data[4][..1].ToEnum<EficazFramework.SPED.Schemas.NFe.OrigemMercadoria>(EficazFramework.SPED.Schemas.NFe.OrigemMercadoria.Nacional);
        CST_ICMS = (EficazFramework.SPED.Schemas.NFe.CST_ICMS)data[4].Substring(1, 2).ToEnum<EficazFramework.SPED.Schemas.NFe.CST_ICMS>(EficazFramework.SPED.Schemas.NFe.CST_ICMS.CST_00);
    ...
    public EficazFramework.SPED.Schemas.NFe.OrigemMercadoria Origem { get; set; } = EficazFramework.SPED.Schemas.NFe.OrigemMercadoria.Nacional; // 4
    public EficazFramework.SPED.Schemas.NFe.CST_ICMS CST_ICMS { get; set; } = EficazFramework.SPED.Schemas.NFe.CST_ICMS.CST_00; // 4
