...
/// </summary>
/// <remarks></remarks>
public class RegistroD100 : Registro
{
    ...
    public override void LeParametros(string[] data)
    {
        ...
        if (EspecieDocumento == "57")
        {
            TipoCTe = (EficazFramework.SPED.Schemas.CTe.TipoCTe)data[13].ToEnum<EficazFramework.SPED.Schemas.CTe.TipoCTe>(EficazFramework.SPED.Schemas.CTe.TipoCTe.Normal);
        }
    ...
    public EficazFramework.SPED.Schemas.CTe.TipoCTe TipoCTe { get; set; } = EficazFramework.SPED.Schemas.CTe.TipoCTe.Normal; // 13
