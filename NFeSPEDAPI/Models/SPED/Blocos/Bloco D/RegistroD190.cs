...
/// </summary>
/// <remarks></remarks>
public class RegistroD190 : Registro
{
    public RegistroD190() : base("D190")
    {
    }

    public RegistroD190(string linha, string versao) : base(linha, versao)
    {
    }
    ...
    public override string EscreveLinha()
    {
        ...
        writer.Append(string.Format("{0:0.##}", ValorReducaoBaseCalculoICMS) + "|"); // 8
        writer.Append(CodigoObservavao + "|"); // 9
    ...
    public override void LeParametros(string[] data)
    {
        ...
        ValorReducaoBaseCalculoICMS = data[8].ToNullableDouble();
        CodigoObservavao = data[9];
    }
    ...
    public double? ValorReducaoBaseCalculoICMS { get; set; } = default; // 8
    public string CodigoObservavao { get; set; } = null; // 9
}
