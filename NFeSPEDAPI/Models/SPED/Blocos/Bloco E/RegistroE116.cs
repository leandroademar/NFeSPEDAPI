...
/// </summary>
public class RegistroE116 : Registro
{
    public RegistroE116() : base("E116")
    {
    }

    public RegistroE116(string linha, string versao) : base(linha, versao)
    {
    }
    ...
    public override string EscreveLinha()
    {
        ...
        writer.Append(MesReferencia.ToSintegraString(EficazFramework.SPED.Extensions.DateFormat.MMAAAA) + "|"); // 10
    ...
    public override void LeParametros(string[] data)
    {
        ...
        MesReferencia = data[10].ToDate(EficazFramework.SPED.Extensions.DateFormat.MMAAAA);
    }
