...
/// </summary>
public class RegistroE250 : Registro
{
    ...
    public override string EscreveLinha()
    {
        ...
        writer.Append(DataVencimento.ToSintegraString(EficazFramework.SPED.Extensions.DateFormat.MMAAAA) + "|"); // 10
    ...
    public override void LeParametros(string[] data)
    {
        ...
        DataVencimento = data[10].ToDate(EficazFramework.SPED.Extensions.DateFormat.MMAAAA);
    }
